...
CREATE TABLE RUTINA(
ID INT,
ID_EJERCICIO INT FOREIGN KEY REFERENCES EJERCICIO(ID),
...
INSERT INTO USUARIO (MAIL, PASWORD)
VALUES 
('usuario1@example.com', 'contraseña1'),
('usuario2@example.com', 'contraseña2'),
('usuario3@example.com', 'contraseña3'),
('usuario4@example.com', 'contraseña4'),
('usuario5@example.com', 'contraseña5'),
('usuario6@example.com', 'contraseña6'),
('usuario7@example.com', 'contraseña7'),
('usuario8@example.com', 'contraseña8'),
('usuario9@example.com', 'contraseña9'),
('usuario10@example.com', 'contraseña10'),
('usuario11@example.com', 'contraseña11'),
('usuario12@example.com', 'contraseña12'),
('usuario13@example.com', 'contraseña13'),
('usuario14@example.com', 'contraseña14'),
('usuario15@example.com', 'contraseña15'),
('usuario16@example.com', 'contraseña16'),
('usuario17@example.com', 'contraseña17'),
('usuario18@example.com', 'contraseña18'),
('usuario19@example.com', 'contraseña19'),
('usuario20@example.com', 'contraseña20'),
('usuario21@example.com', 'contraseña21'),
('usuario22@example.com', 'contraseña22'),
('usuario23@example.com', 'contraseña23'),
('usuario24@example.com', 'contraseña24'),
('usuario25@example.com', 'contraseña25'),
('usuario26@example.com', 'contraseña26'),
('usuario27@example.com', 'contraseña27'),
('usuario28@example.com', 'contraseña28'),
('usuario29@example.com', 'contraseña29'),
('usuario30@example.com', 'contraseña30');
GO
...
INSERT INTO RUTINA (ID, ID_EJERCICIO, DIA, ID_PERSONA)
VALUES 
(1, 1, 1, 1),
(1, 2, 1, 1),
(1, 3, 2, 1),
