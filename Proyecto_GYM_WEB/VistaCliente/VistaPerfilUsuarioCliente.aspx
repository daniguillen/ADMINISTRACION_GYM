           ...
           <!--FOTO DE PERFIL-->
            ...
            <di class="col-6">
                ...
                <div class="form-group">
                    ...
                    <label  for="TxtDniEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%> )  >DNI</label>
                ...
                <div class="form-group">
                    <label for="TxtPlanEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%>>Plan:</label>
                    <asp:TextBox ID="TxtPlanEditar" runat="server" CssClass="form-control" ></asp:TextBox>
                </div>

                <div class="form-group">
                    <label for="TxtCelularEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%>>Celular:</label>
                    <asp:TextBox ID="TxtCelularEditar" runat="server" CssClass="form-control"></asp:TextBox>
                </div>

                <div class="form-group">
                    <label for="TxtTelEmergenciaEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%>>Tel Emergencia:</label>
                ...
                <div class="form-group">
                    <label for="TxtPasswordEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%>>Password:</label>
                    <asp:TextBox ID="TxtPasswordEditar" runat="server" CssClass="form-control" ></asp:TextBox>
                </div>

                <div class="form-group">
                    <label for="TxtFechaNacimientoEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%> >Fecha Nacimiento:</label>
                    <asp:TextBox ID="TxtFechaNacimientoEditar" Type="date"  runat="server" CssClass="form-control" ></asp:TextBox>
                </div>

                <div class="form-group">
                    <label for="TxtSexoEditar"  Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%>>Sexo:</label>
                ...
                <div class="form-group">
                    <label for="TxtFechaIngresoEditar" Class="text-light mt-2" <% if(nivel.Equals("2")){%> style="display:none" <%}%>>Fecha Ingreso:</label>
